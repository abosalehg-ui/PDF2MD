...
# سقف طول المعاينة المعروضة في الواجهتين الرسومية والويب. كتاب من ٩٠٠
# صفحة يُنتج ملفًا بملايين الحروف، ورسمه في عنصر واحد يجمّد الواجهة.
# التنزيل والحفظ يأخذان الناتج كاملًا — المقصوص هو المعروض وحده.
#
# هنا لا في كل واجهة: كان معرَّفًا مرّتين (web.py و gui_theme.py) ومكتوبًا
# نصًّا ثالثة في رسالة app.js، فثلاثة مواضع تتباعد عند أول تغيير.
